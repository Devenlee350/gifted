...
const config = {
  SESSION_ID: process.env.SESSION_ID || "Gifted~Y95D5w10",
  ...
  AUTO_DOWNLOAD: process.env.AUTO_DOWNLOAD !== undefined ? process.env.AUTO_DOWNLOAD === 'false' : true,
  ...
  OWNER_NUMBER: process.env.OWNER_NUMBER || "263784562833",
